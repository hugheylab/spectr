...
test_that('spectr CSP Greedy', {
  ...
  spectrAllEqGreedyChisq = all.equal(greedyChisq, specExpect, check.attributes = FALSE)
  write(spectrAllEqGreedyChisq, file = "spectr_all_eq_greedy_chisq.txt")
  expect_true(all.equal(greedyChisq, specExpect, check.attributes = FALSE))
...
test_that('spectr CSP Conservative', {
  ...
  spectrAllEqConsChisq = all.equal(conservativeChisq, specExpect, check.attributes = FALSE, tolerance = 0.001)
  write(spectrAllEqConsChisq, file = "spectr_all_eq_cons_chisq.txt")
  expect_true(all.equal(conservativeChisq, specExpect, check.attributes = FALSE, tolerance = 0.001))
})
...
test_that('spectr CSP Standard', {
  ...
  spectrAllEqStandardChisq = all.equal(standardChisq, specExpect, check.attributes = FALSE, tolerance = 0.001)
  write(spectrAllEqStandardChisq, file = "spectr_all_eq_standard_chisq.txt")
  expect_true(all.equal(standardChisq, specExpect, check.attributes = FALSE, tolerance = 0.001))
})
...
test_that('spectr Lomb Scargle', {
  ...
  spectrAllEqLombs = all.equal(lombscargle, specExpect, check.attributes = FALSE, tolerance = 0.001)
  write(spectrAllEqLombs, file = "spectr_all_eq_lombs.txt")
  expect_true(all.equal(lombscargle, specExpect, check.attributes = FALSE, tolerance = 0.001))
})
...
test_that('spectr FFT', {
  ...
  spectrAllEqFft = all.equal(fft, specExpect, check.attributes = FALSE, tolerance = 0.001)
  write(spectrAllEqFft, file = "spectr_all_eq_fft.txt")
  expect_true(all.equal(fft, specExpect, check.attributes = FALSE, tolerance = 0.001))
})
